! function(e, t) {
    ...
    return function(e) {
        ...
        t.default = function(e) {
            ...
            }(!(m.props instanceof Array), "`props` should be an object, not Array"), o({}, "undefined" != typeof GENERATE_DOC ? {
                $vgmOptions: e
            } : {}, {
                mixins: [u.default],
                props: o({}, f, c(t)),
                ...
                provide: function() {
                    var e = this,
                        n = this.$mapPromise.then(function(n) {
                            ...
                            var r = o({}, e.options, {
                                map: n
                            }, (0, i.getPropsValues)(e, t));
                            if (delete r.options, p) {
                                var a = p.bind(e)(r);
                            ...
                            return e[v] = s ? new((o = Function.prototype.bind).call.apply(o, [c, null].concat(function(e) {
                                ...
                                return Array.from(e)
                            }(s(u, (0, i.getPropsValues)(e, f || {})))))) : new c(u), (0, i.bindProps)(e, e[v], t), (0, a.default)(e, e[v], l), d && d.bind(e)(e[v]), e[v]
                        });
                    return this[h] = n,
                        function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            var r = function(r) {
                ...
                var p = "set" + i(r),
                    d = "get" + i(r),
                    f = r.toLowerCase() + "_changed",
                    m = e[r];
                if (void 0 === t[p]) throw new Error(p + " is not a method of (the Maps object corresponding to) " + e.$options._componentTag);
                s === Object && c ? (0, a.default)(e, c.map(function(e) {
                    return r + "." + e
                }), function() {
                    t[p](e[r])
                }, void 0 !== e[r]) : e.$watch(r, function() {
                    var n = e[r];
                    t[p](n)
                }, {
                    immediate: void 0 !== m,
                    deep: s === Object
                }), u && (e.$gmapOptions.autobindAllEvents || e.$listeners[f]) && t.addListener(f, function() {
                    e.$emit(f, t[d]())
                })
            };
            for (var o in n) r(o)
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.default = (r = n(31)).default || r
    }, function(e, t, n) {
        "use strict";
        var r;
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.default = (r = n(35)).default || r
    }, function(e, t, n) {
        "use strict";
        var r;
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.default = (r = n(39)).default || r
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        t.default = {
            mounted: function() {
                ...
                t.value = this.defaultPlace, this.$watch("defaultPlace", function() {
                    ...
                    var t = (0, o.getPropsValues)(e, u);
                    if (e.selectFirstOnEnter && (0, i.default)(e.$refs.input), "function" != typeof google.maps.places.Autocomplete) throw new Error("google.maps.places.Autocomplete is undefined. Did you add 'places' to libraries when loading Google Maps?");
                    ...
                    (0, o.bindProps)(e, e.autoCompleter, n), e.autoCompleter.addListener("place_changed", function() {
        ...
        function y(e) {
            ...
            if (f) {
                var o = s++;
                r = u || (u = v()), t = _.bind(null, r, o, !1), n = _.bind(null, r, o, !0)
        ...
        t.install = function(e, t) {
            ...
            var n = new e,
                v = function(e) {
                    function t() {
                        return w.gmapApi = {}, window.google
                    }
        ...
        t.loadGmapApi = function(e, t) {
            if ("undefined" != typeof document) {
                ...
                "boolean" == typeof t && !0 === t && (a = "https://maps.google.cn/");
            ...
            afterCreate: function() {
                ...
                this.$watch("path", function(n) {
                    if (n) {
                        ...
                        var r = e.$polylineObject.getPath(),
                            a = [],
                            i = function() {
                                e.$emit("path_changed", e.$polylineObject.getPath())
                            };
                        a.push([r, r.addListener("insert_at", i)]), a.push([r, r.addListener("remove_at", i)]), a.push([r, r.addListener("set_at", i)]), t = function() {
                            a.map(function(e) {
                                var t = o(e, 2),
                                    n = (t[0], t[1]);
        ...
        var i = n(11),
            u = n(1),
            s = Object(u.a)(o.a, i.a, i.b, !1, null, null, null);
        t.default = s.exports
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
        ...
        (e.exports = n(17)()).push([e.i, ".vue-map-container{position:relative}.vue-map-container .vue-map{left:0;right:0;top:0;bottom:0;position:absolute}.vue-map-hidden{display:none}", ""])
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var p = {
            ...
            d = ["bounds_changed", "click", "dblclick", "drag", "dragend", "dragstart", "idle", "mousemove", "mouseout", "mouseover", "resize", "rightclick", "tilesloaded"],
        ...
        t.default = {
            mixins: [i.default],
            props: (0, c.mappedPropsToVueProps)(p),
            provide: function() {
                var e = this;
            ...
            mounted: function() {
                ...
                return this.$gmapApiPromiseLazy().then(function() {
                    var t = e.$refs["vue-map"],
                        n = r({}, e.options, (0, a.getPropsValues)(e, p));
                    return delete n.options, e.$mapObject = new google.maps.Map(t, n), (0, a.bindProps)(e, e.$mapObject, p), (0, o.default)(e, e.$mapObject, d), (0, u.default)(function(t, n, r) {
        ...
        (e.exports = n(17)()).push([e.i, ".vue-street-view-pano-container{position:relative}.vue-street-view-pano-container .vue-street-view-pano{left:0;right:0;top:0;bottom:0;position:absolute}", ""])
    }, function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
            ...
            mounted: function() {
                ...
                return this.$gmapApiPromiseLazy().then(function() {
                    var t = e.$refs["vue-street-view-pano"],
                        n = r({}, e.options, (0, a.getPropsValues)(e, p));
                    return delete n.options, e.$panoObject = new google.maps.StreetViewPanorama(t, n), (0, a.bindProps)(e, e.$panoObject, p), (0, o.default)(e, e.$panoObject, d), (0, u.default)(function(t, n, r) {
        ...
        t.default = {
            mounted: function() {
                var e = this;
                this.$gmapApiPromiseLazy().then(function() {
                    if (e.selectFirstOnEnter && (0, u.default)(e.$refs.input), "function" != typeof google.maps.places.Autocomplete) throw new Error("google.maps.places.Autocomplete is undefined. Did you add 'places' to libraries when loading Google Maps?");
                    var t = o({}, (0, a.getPropsValues)(e, c), e.options);
                    e.$autocomplete = new google.maps.places.Autocomplete(e.$refs.input, t), (0, a.bindProps)(e, e.$autocomplete, c), e.$watch("componentRestrictions", function(t) {
